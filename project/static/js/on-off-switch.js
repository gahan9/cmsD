...
$.extend(DG.OnOffSwitch.prototype, {
    ...
    render: function () {
        ...
        this.cls = $('<div class="on-off-switch" style="width:' + this.width + 'px;height:' + this.height + 'px"></div>');
        this.inputEl.after(this.cls);
